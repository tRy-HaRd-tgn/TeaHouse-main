  ...
  return (
    <>
      <header className="Main_App_header">
        <div className="Main_App_header_user">
          <img
            src="/img/person.png"
            alt=""
            className="Main_App_header_block_img"
          />
          <p className="Main_App_header_user_p">ФИО пользователя</p>
          <div className="Main_App_header_s_block_img">
            <img className="Main_App_header_img" src="/img/sign.svg" alt="" />
          </div>
        </div>
      </header>
      <body className="Main_App_container">
